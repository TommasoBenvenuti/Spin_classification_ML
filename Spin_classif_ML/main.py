...
if performe_data_balancing:
    OUT_DIR_ML      = "../results/spin_classif_ML_balanced"
    OUT_DIR_SVM_RFC = "../results/SVM_RFC_balanced"
else:
    OUT_DIR_ML      = "../results/spin_classif_ML_unbalanced"
...
X_scaled, X_train, X_test, y_train_spin, y_test_spin = scale_and_split_data(X, y_spin, TEST_SIZE, RANDOM_STATE)
