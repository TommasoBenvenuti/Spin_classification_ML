...
High-performance computing (HPC) techniques for spin-state classification in inorganic complexes are computationally demanding. Recently, machine learning approaches have emerged as efficient alternatives for this task ([ACS JPCA reference](https://pubs.acs.org/doi/10.1021/acs.jpca.0c01458)).
